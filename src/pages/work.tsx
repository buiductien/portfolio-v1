        ...
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          ...
          >
            <div className="flex flex-col gap-[30px] h-[50%]">
              ...
              <h2
               ...
               group-hover:text-accent trasition-all duration-500 capitalize"
              >
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              {/* slider button */}
              <WorkSliderBtns
                containerStyle="flex gap-2 absolute right-0 bottom-[calc(50%-22px)]
              xl:bottom-0 z-20 w-full justify-between xl:w-max xl:justify-none"
                btnStyle="bg-accent hover:bg-accent-hover text-primary text-[22px] w-[44px]
