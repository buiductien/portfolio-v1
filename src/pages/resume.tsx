...
const about = {
  ...
  info: [
    {
      fieldName: "Name",
      feildValue: "Luke Coleman",
    },
    {
      fieldName: "Phone",
      feildValue: "(+40) 321 677 999",
    },
    {
...
const education = {
  ...
  items: [
    {
      instuition: "Oneline Course Platform",
      degree: "Full Stack Web Development Bootcamp",
      duration: "2023",
    },
    {
      instuition: "Codecademy",
      degree: "Font-end Track ",
      duration: "2022",
    },
    {
      instuition: "Oneline Course",
      degree: "Programing Course",
      duration: "2020 - 2021",
    },
    {
      instuition: "Tech instution",
      degree: "Certificated Web Developer",
      duration: "2019",
    },
    {
      instuition: "Design School",
      degree: "Diploma in Graphic Design",
      duration: "2016 - 2018",
    },
    {
      instuition: "Comunity College",
      degree: "Diploma in Graphic Design",
      duration: "2014 - 2018",
    },
  ],
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3">
                            {/* dot */}
                            <span className="w-[6px] h-[6px] rounded-full bg-accent"></span>
                            <p className="text-white/60">{item.instuition}</p>
                          </div>
                        </li>
                      );
                    })}
